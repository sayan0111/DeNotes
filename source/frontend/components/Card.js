...
const Card = ({
  ...
  return (
    <div>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 w-full bg-slate-800   ">
        <div className="relative mx-auto w-full pl-3">
          <a
            href="#"
            ...
            <div className="shadow p-6  rounded-lg bg-white">
              ...
              <div className="grid grid-cols-2 grid-rows-2 gap-4 mt-8">
                <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                  ...
                  <span className="mt-2 xl:mt-0">{subject}</span>
                </p>
                ...
                <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                  ...
                  <span className="mt-2 md:mt-0">{college}</span>
                </p>
                <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                  {/* <svg
                    className="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-gray-800"
                ...
                <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                  ...
                  <span className="mt-2 md:mt-0">{department}</span>
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 mt-8">
                <div className="flex items-center">
                  ...
                  <p className="ml-2 text-gray-800 line-clamp-1">{seller}</p>
                </div>
